...
__all__ = ['componentTemplate', 'chunkTemplate', 'rootStructTemplate', 'outLeftRight', 'recordLinks', 'checkForBreak',
           'nodeStat', 'finaliseComponentBase', 'processAnnotationInterval', 'combineAnnotation', 'updateEdges',
           'baseLayerZoom', 'splitforwardInversedNodeComp', 'fillLinksBase', 'convertLink', 'recordUpdatedPairedLink',
...
#         print(f'\rPostprocessing links blocks {recordNum+1}/{numInterLinks}',end='')
